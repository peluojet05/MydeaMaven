            ...
            <div class="w-100 h-100 cont_busq_res_txt d-flex flex-column Inria">
                ...
                <div class="cont_busq_res">
                   ...
                   <%
                    ...
                    <%
                        PreparedStatement ps2 = c.prepareStatement("SELECT p.per_foto, p.per_descripcion, per_id, u.usu_nombre, u.tip_id FROM Persona p INNER JOIN Usuario u ON u.usu_id=p.usu_id WHERE u.usu_activo=true and usu_nombre ILIKE ?");
                        ps2.setString(1, "%" + bs + "%");
                    ...
                    <%
                         PreparedStatement ps3 = c.prepareStatement("SELECT * FROM Producto p inner join Negocio n on p.neg_id=n.neg_id"
                                + " WHERE p.pro_activo=true and n.neg_activo=true and p.pro_nombre ILIKE ?");
                        ps3.setString(1, "%" + bs + "%");
