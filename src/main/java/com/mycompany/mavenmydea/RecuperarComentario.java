 ...
 * @author Usuario
 */
@WebServlet(name = "RecuperarComentario", urlPatterns = {"/RecuperarComentario"})
public class RecuperarComentario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String id = request.getParameter("idc");
                ...
                con.setCon();
                c=con.getCon();
                String mensaje = con.RecuperarC(id);
