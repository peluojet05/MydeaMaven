 ...
 * @author diego
 */
@WebServlet(name = "EliminarComentarioA", urlPatterns = {"/EliminarComentarioA"})
public class EliminarComentarioA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            con.setCon();
            c=con.getCon();
            String mensaje = con.EliminarC(id);
